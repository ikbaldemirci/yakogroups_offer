...
export const kidsActivitiesCategory: Category = {
  ...
  description: "Çocuklar için eğlenceli ve eğitici aktiviteler",
    ...
    },
    {
        ...
        subcategory: "gosteriler",
        type: "fixed",
        title: "Bando Takımı Gösterisi",
        summary: "Etkinliğe enerji katan ritmik müzik performansı.",
        price: 0,
        currency: "TRY",
        vatIncluded: false,
        photoUrl: "https://res.cloudinary.com/deb8zn714/image/upload/q_auto/f_auto/v1776522800/bando_vy2t1j.jpg"
    },
    {
        id: "ka19",
        category: "kids-activities",
